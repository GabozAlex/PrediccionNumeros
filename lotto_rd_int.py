...
CONFIG = {
    'nombre': 'Lotto Activo Rd Int',
    'animales': ANIMALES_38,
    'grupos_animales': GRUPOS_ANIMALES,
    'max_numero': 37,
    'excel_file': 'data/LottoActivoRDInt.xlsx',
    'modelos_dir': 'modelos/lotto_rd_int',
    'logger_name': 'lotto_rd_int',
}
...
analizar_fallos_por_dia_semana = analizador.analizar_fallos_por_dia_semana
analizar_fallos_por_hora = analizador.analizar_fallos_por_hora
